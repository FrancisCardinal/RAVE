const common = {
  ...
  eyeTrackerCalibrationPage: {
    ...
    next: 'Next',
    instruction: 'Press play to replicate the mouvement shown bellow and pause when finished and press "Next" for the following mouvement:',
    offsetInstruction: 'Look straight ahead at the yellow duck and snap a picture.',
