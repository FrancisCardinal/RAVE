const common = {
  ...
  eyeTrackerCalibrationPage: {
    ...
    next: 'Prochain',
    instruction: 'Appuyer sur Play et pour faire le mouvement indiqué et pause à la fin et appuyer sur "Prochain":',
    offsetInstruction: 'Regarder droit devant au canard jaune et appuyer sur le bouton photo.',
