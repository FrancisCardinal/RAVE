...
class DatasetBuilder(ABC):
    ...
    def __init__(self, 
        ...
        self.ANNOTATIONS_PATH = os.path.join(DatasetBuilder.ROOT_PATH, SOURCE_DIR, DatasetBuilder.ANNOTATIONS_DIR)
    ...
    def create_images_of_one_video_group(self):
        ...
        for video_file_name in tqdm(self.VIDEOS, leave=False, desc=self.log_name) : 
            ...
            annotations_file = open(os.path.join(self.ANNOTATIONS_PATH, file_name + '.txt'), 'r')
    ...
    def create_images_dataset_with_one_video(self, 
        ...
        while(cap.isOpened()):
            ...
            self.process_image_label_pair(processed_frame, file_name, annotations,  INPUT_IMAGE_WIDTH, INPUT_IMAGE_HEIGHT)
