...
class LaSOTDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        if self.vos_mode:
            ...
            masks = [
                self._load_mask(Path(self._get_anno_frame_path(seq_mask_path, f[-12:-3] + "png")))
    ...
    def _load_attributes(self):
        with open(
            os.path.join(
                os.path.dirname(os.path.realpath(__file__)), "dataset_attribute_specs", "LaSOT_attributes.json"
            ),
            "r",
        ) as f:
