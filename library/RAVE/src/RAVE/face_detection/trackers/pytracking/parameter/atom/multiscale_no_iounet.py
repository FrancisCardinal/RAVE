...
def parameters():
    ...
    params.init_GN_iter = (
        6  # The number of Gauss-Newton iterations used in the first frame (only if the projection matrix is updated)
    )
    ...
    deep_feat = deep.ATOMResNet18(
        net_path="atom_default.pth", output_layers=["layer3"], fparams=deep_fparams, normalize_power=2
    )
