...
def main():
    ...
    parser.add_argument(
        "--output_path", type=str, default=None, help="Path to the directory where the results will be unpacked."
    )
    parser.add_argument(
        "--temp_download_path", type=str, default=None, help="Temporary path used for downloading the Zip files."
    )
    parser.add_argument(
        "--download", type=bool, default=True, help="Whether to download results or unpack existing downloaded files."
    )
