...
class TargetCandidateMatchingNetwork(nn.Module):
    ...
    def forward(
        ...
        img_cropped0,
        img_cropped1,
        candidate_tsm_coords0,
        candidate_tsm_coords1,
        candidate_img_coords0,
        candidate_img_coords1,
        candidate_scores0,
        candidate_scores1,
        img_shape0,
        img_shape1,
...
@model_constructor
def target_candidate_matching_net_resnet50(
    ...
    net = TargetCandidateMatchingNetwork(
