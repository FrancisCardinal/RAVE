...
def run(settings):
    ...
    settings.center_jitter_factor = {"train": 0.0, "test": 4.5}
    settings.scale_jitter_factor = {"train": 0.0, "test": 0.5}
    ...
    loader_val = LTRLoader(
        ...
        shuffle=False,
        drop_last=True,
        epoch_interval=settings.val_epoch_interval,
        stack_dim=1,
    )

    # Create network and actor
    net = tompnet.tompnet101(
