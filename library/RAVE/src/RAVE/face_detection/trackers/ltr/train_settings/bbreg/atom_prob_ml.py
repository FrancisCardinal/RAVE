...
def run(settings):
    ...
    settings.description = (
        "ATOM using the probabilistic maximum likelihood trained regression model for bounding-box"
    ...
    dataset_val = sampler.ATOMSampler(
        [got10k_val], [1], samples_per_epoch=500 * settings.batch_size, max_gap=200, processing=data_processing_val
    )
