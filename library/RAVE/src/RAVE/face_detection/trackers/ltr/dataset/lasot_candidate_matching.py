...
class LasotCandidateMatching(BaseVideoDataset):
    ...
    def __init__(
        self, root=None, path_to_json=None, image_loader=jpeg4py_loader, vid_ids=None, split=None, data_fraction=None
    ):
        """
        args:
    ...
    def _read_bb_anno(self, seq_path):
        ...
        gt = pandas.read_csv(
            bb_anno_file, delimiter=",", header=None, dtype=np.float32, na_filter=False, low_memory=False
        ).values
    ...
    def _get_data(self, seq_id, seq_img_path, frame_id):
        ...
        return dict(
            ...
            img=img,
            target_anno_coord=target_anno_coord,
