...
if __name__ == '__main__':
    ...
    parser.add_argument('--image', type=str, default='file/folder', help='source')  # file/folder, 0 for webcam
    ...
    while True:
        ...
        if frame is None:
            ...
            break
        new_frame = detect_one(model, frame, device)
        new_frame = fps.writeFpsToFrame(new_frame)

        cv2.imshow('Capture - Face detection', new_frame)
